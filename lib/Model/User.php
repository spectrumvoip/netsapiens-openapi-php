    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling User., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[A-Za-z0-9._-]+|\\*/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling User., must conform to the pattern /^[A-Za-z0-9._-]+|\\*/.");
        }
    ...
    public function setDirectoryNameNumberDtmfMapping($directory_name_number_dtmf_mapping)
    {
        ...
        if (($directory_name_number_dtmf_mapping > 999)) {
            throw new \InvalidArgumentException('invalid value for $directory_name_number_dtmf_mapping when calling User., must be smaller than or equal to 999.');
        }
        if (($directory_name_number_dtmf_mapping < 100)) {
            throw new \InvalidArgumentException('invalid value for $directory_name_number_dtmf_mapping when calling User., must be bigger than or equal to 100.');
        }
    ...
    public function setRingNoAnswerTimeoutSeconds($ring_no_answer_timeout_seconds)
    {
        ...
        if (($ring_no_answer_timeout_seconds > 3600)) {
            throw new \InvalidArgumentException('invalid value for $ring_no_answer_timeout_seconds when calling User., must be smaller than or equal to 3600.');
        }
        if (($ring_no_answer_timeout_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $ring_no_answer_timeout_seconds when calling User., must be bigger than or equal to 0.');
        }
    ...
    public function setLimitsMaxDataStorageKilobytes($limits_max_data_storage_kilobytes)
    {
        ...
        if (($limits_max_data_storage_kilobytes < 0)) {
            throw new \InvalidArgumentException('invalid value for $limits_max_data_storage_kilobytes when calling User., must be bigger than or equal to 0.');
        }
    ...
    public function setLimitsMaxActiveCallsTotal($limits_max_active_calls_total)
    {
        ...
        if (($limits_max_active_calls_total > 3600)) {
            throw new \InvalidArgumentException('invalid value for $limits_max_active_calls_total when calling User., must be smaller than or equal to 3600.');
        }
        if (($limits_max_active_calls_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $limits_max_active_calls_total when calling User., must be bigger than or equal to 0.');
        }
    ...
    public function setDirectoryOverrideOrderDuplicateDtmfMapping($directory_override_order_duplicate_dtmf_mapping)
    {
        ...
        if (($directory_override_order_duplicate_dtmf_mapping > 100)) {
            throw new \InvalidArgumentException('invalid value for $directory_override_order_duplicate_dtmf_mapping when calling User., must be smaller than or equal to 100.');
        }
        if (($directory_override_order_duplicate_dtmf_mapping < 0)) {
            throw new \InvalidArgumentException('invalid value for $directory_override_order_duplicate_dtmf_mapping when calling User., must be bigger than or equal to 0.');
        }
    ...
    public function setVoicemailGreetingIndex($voicemail_greeting_index)
    {
        ...
        if (($voicemail_greeting_index < 0)) {
            throw new \InvalidArgumentException('invalid value for $voicemail_greeting_index when calling User., must be bigger than or equal to 0.');
        }
    ...
    public function setCallerIdNumber($caller_id_number)
    {
        ...
        if (($caller_id_number < 10)) {
            throw new \InvalidArgumentException('invalid value for $caller_id_number when calling User., must be bigger than or equal to 10.');
        }
    ...
    public function setCallerIdNumberEmergency($caller_id_number_emergency)
    {
        ...
        if (($caller_id_number_emergency < 10)) {
            throw new \InvalidArgumentException('invalid value for $caller_id_number_emergency when calling User., must be bigger than or equal to 10.');
        }
    ...
    public function setAreaCode($area_code)
    {
        ...
        if (($area_code > 999)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling User., must be smaller than or equal to 999.');
        }
        if (($area_code < 100)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling User., must be bigger than or equal to 100.');
        }
    ...
    public function setMusicOnHoldComfortMessageRepeatIntervalSeconds($music_on_hold_comfort_message_repeat_interval_seconds)
    {
        ...
        if (($music_on_hold_comfort_message_repeat_interval_seconds > 3600)) {
            throw new \InvalidArgumentException('invalid value for $music_on_hold_comfort_message_repeat_interval_seconds when calling User., must be smaller than or equal to 3600.');
        }
        if (($music_on_hold_comfort_message_repeat_interval_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $music_on_hold_comfort_message_repeat_interval_seconds when calling User., must be bigger than or equal to 0.');
        }
