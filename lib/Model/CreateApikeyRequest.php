    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 12)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateApikeyRequest., must be bigger than or equal to 12.');
        }
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling CreateApikeyRequest., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[A-Za-z0-9._-]+|\\*/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling CreateApikeyRequest., must conform to the pattern /^[A-Za-z0-9._-]+|\\*/.");
        }
