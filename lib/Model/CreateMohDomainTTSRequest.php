...
/**
 * CreateMohDomainTTSRequest Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class CreateMohDomainTTSRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMohDomainTTS_request';
    ...
    */
     ...
     * Sets index
     *
     * @param int|null $index The index of the file, Example \"2\" for greeting 2. In create (POST) requests index cab be omitted and the API will select a new index automatically.
     *
     * @return self
     */
