<?php
/**
 * DomainsDomainUsersUserMeetingsGetIdPost200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DomainsDomainUsersUserMeetingsGetIdPost200Response Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class DomainsDomainUsersUserMeetingsGetIdPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_domains__domain__users__user__meetings_getId_post_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['phonenumbers'] === null) {
            $invalidProperties[] = "'phonenumbers' can't be null";
        }
     ...
     * Sets phonenumbers
     *
     * @param string $phonenumbers Dial in phone number
     *
     * @return self
     */
