<?php
/**
 * UpdateMessageSessionSessionNameRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateMessageSessionSessionNameRequest Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class UpdateMessageSessionSessionNameRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateMessageSessionSessionName_request';
    ...
    */
     ...
     * Sets session_name
     *
     * @param string $session_name This is the new name of the message session
     *
     * @return self
     */
