...
/**
 * DomainsDomainSitesSitePutRequest Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class DomainsDomainSitesSitePutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_domains__domain__sites__site__put_request';
    ...
    */
    ...
    public function setLimitsMaxDataStorageKilobytes($limits_max_data_storage_kilobytes)
    {
        ...
        if (($limits_max_data_storage_kilobytes < 0)) {
            throw new \InvalidArgumentException('invalid value for $limits_max_data_storage_kilobytes when calling DomainsDomainSitesSitePutRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setLimitsMaxActiveCallsTotal($limits_max_active_calls_total)
    {
        ...
        if (($limits_max_active_calls_total > 3600)) {
            throw new \InvalidArgumentException('invalid value for $limits_max_active_calls_total when calling DomainsDomainSitesSitePutRequest., must be smaller than or equal to 3600.');
        }
        if (($limits_max_active_calls_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $limits_max_active_calls_total when calling DomainsDomainSitesSitePutRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCallerIdNumber($caller_id_number)
    {
        ...
        if (($caller_id_number < 10)) {
            throw new \InvalidArgumentException('invalid value for $caller_id_number when calling DomainsDomainSitesSitePutRequest., must be bigger than or equal to 10.');
        }
    ...
    public function setCallerIdNumberEmergency($caller_id_number_emergency)
    {
        ...
        if (($caller_id_number_emergency < 10)) {
            throw new \InvalidArgumentException('invalid value for $caller_id_number_emergency when calling DomainsDomainSitesSitePutRequest., must be bigger than or equal to 10.');
        }
    ...
    public function setAreaCode($area_code)
    {
        ...
        if (($area_code > 999)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling DomainsDomainSitesSitePutRequest., must be smaller than or equal to 999.');
        }
        if (($area_code < 100)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling DomainsDomainSitesSitePutRequest., must be bigger than or equal to 100.');
        }
