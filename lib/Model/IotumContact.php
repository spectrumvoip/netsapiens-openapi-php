...
/**
 * IotumContact Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class IotumContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IotumContact';
    ...
    */
     ...
     * Sets business_phone
     *
     * @param string|null $business_phone optional, business phone number
     *
     * @return self
     */
     ...
     * Sets mobile_phone
     *
     * @param string|null $mobile_phone optional, mobile phone number
     *
     * @return self
     */
     ...
     * Sets home_phone
     *
     * @param string|null $home_phone optional, home phone number
     *
     * @return self
     */
     ...
     * Sets other_phone
     *
     * @param string|null $other_phone optional, other phone number
     *
     * @return self
     */
     ...
     * Sets time_zone
     *
     * @param string|null $time_zone optional, IANA time zone name. Values are those (e.g. US/Central, Europe/London, Asia/Tokyo, etc.) in the IANA Time Zone database (https://www.iana.org/time-zones)
     *
     * @return self
     */
