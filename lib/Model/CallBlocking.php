...
/**
 * CallBlocking Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class CallBlocking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CallBlocking';
    ...
    protected static $openAPITypes = [
        ...
        'is_active' => 'bool',
        'phone_numbers_to_reject' => '\SpectrumVoip\\\\NetSapiens\Model\CallBlockingPhoneNumbersToReject'
    ];
    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling CallBlocking., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[A-Za-z0-9._-]+|\\*/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling CallBlocking., must conform to the pattern /^[A-Za-z0-9._-]+|\\*/.");
        }
     ...
     * Sets is_active
     *
     * @param bool|null $is_active This is read only option that will be true if this timeframe is active for this user when taking into account current settings, date/time and all timeframes.
     *
     * @return self
     */
     ...
     *
     * @return \SpectrumVoip\\\\NetSapiens\Model\CallBlockingPhoneNumbersToReject|null
     */
     ...
     *
     * @param \SpectrumVoip\\\\NetSapiens\Model\CallBlockingPhoneNumbersToReject|null $phone_numbers_to_reject phone_numbers_to_reject
     *
     * @return self
     */
