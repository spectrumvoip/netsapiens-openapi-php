...
/**
 * CreateCallqueueRequest Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class CreateCallqueueRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCallqueue_request';
    ...
    */
    ...
    public function setCallqueueMaxCallbackQueueingHours($callqueue_max_callback_queueing_hours)
    {
        ...
        if (($callqueue_max_callback_queueing_hours > 6)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_max_callback_queueing_hours when calling CreateCallqueueRequest., must be smaller than or equal to 6.');
        }
        if (($callqueue_max_callback_queueing_hours < 0)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_max_callback_queueing_hours when calling CreateCallqueueRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCallqueueMaxCurrentCallersToAcceptNewCallers($callqueue_max_current_callers_to_accept_new_callers)
    {
        ...
        if (($callqueue_max_current_callers_to_accept_new_callers < 0)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_max_current_callers_to_accept_new_callers when calling CreateCallqueueRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCallqueueMaxCurrentWaitToAcceptNewCallersSeconds($callqueue_max_current_wait_to_accept_new_callers_seconds)
    {
        ...
        if (($callqueue_max_current_wait_to_accept_new_callers_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_max_current_wait_to_accept_new_callers_seconds when calling CreateCallqueueRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCallqueueMaxWaitTimeoutMinutes($callqueue_max_wait_timeout_minutes)
    {
        ...
        if (($callqueue_max_wait_timeout_minutes < 0)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_max_wait_timeout_minutes when calling CreateCallqueueRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCallqueueSimRing1stRound($callqueue_sim_ring_1st_round)
    {
        ...
        if (($callqueue_sim_ring_1st_round > 99)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_sim_ring_1st_round when calling CreateCallqueueRequest., must be smaller than or equal to 99.');
        }
        if (($callqueue_sim_ring_1st_round < 0)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_sim_ring_1st_round when calling CreateCallqueueRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setCallqueueSimRingIncrement($callqueue_sim_ring_increment)
    {
        ...
        if (($callqueue_sim_ring_increment > 99)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_sim_ring_increment when calling CreateCallqueueRequest., must be smaller than or equal to 99.');
        }
        if (($callqueue_sim_ring_increment < 0)) {
            throw new \InvalidArgumentException('invalid value for $callqueue_sim_ring_increment when calling CreateCallqueueRequest., must be bigger than or equal to 0.');
        }
