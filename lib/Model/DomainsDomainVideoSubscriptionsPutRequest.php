<?php
/**
 * DomainsDomainVideoSubscriptionsPutRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DomainsDomainVideoSubscriptionsPutRequest Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class DomainsDomainVideoSubscriptionsPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_domains__domain__video_subscriptions_put_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('default_addons', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets default_plan
     *
     * @param string|null $default_plan default_plan
     *
     * @return self
     */
     ...
     * Sets default_addons
     *
     * @param string[]|null $default_addons default_addons
     *
     * @return self
     */
    public function setDefaultAddons($default_addons)
    {
        if (is_null($default_addons)) {
            throw new \InvalidArgumentException('non-nullable default_addons cannot be null');
        }
