...
class UpdateDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets reseller
     *
     * @param string|null $reseller This is the reseller that owns this domain. Must be a valid resller name on creation. If Reseller level scope you can use \"~\" to set your own reseller on create, Super User's will need to set this to a valid Reseller.
     *
     * @return self
     */
    ...
    public function setAreaCode($area_code)
    {
        ...
        if (($area_code > 999)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling UpdateDomainRequest., must be smaller than or equal to 999.');
        }
        if (($area_code < 100)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling UpdateDomainRequest., must be bigger than or equal to 100.');
        }
