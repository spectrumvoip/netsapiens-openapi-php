 ...
 */
class Reseller implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setReseller($reseller)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9 -_]+/", ObjectSerializer::toString($reseller)))) {
            throw new \InvalidArgumentException("invalid value for \$reseller when calling Reseller., must conform to the pattern /^[A-Za-z0-9 -_]+/.");
        }
