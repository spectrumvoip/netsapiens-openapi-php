    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling CreateConnectionRequest., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[A-Za-z0-9._-]+|\\*/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling CreateConnectionRequest., must conform to the pattern /^[A-Za-z0-9._-]+|\\*/.");
        }
