    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling CreateDomainRequest., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[A-Za-z0-9._-]+|\\*/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling CreateDomainRequest., must conform to the pattern /^[A-Za-z0-9._-]+|\\*/.");
        }
     ...
     * Sets description
     *
     * @param string|null $description This is a description of the domain. This will be shown in many places to help show a more user friendly version of the domain to help identify it.
     *
     * @return self
     */
    ...
    public function setAreaCode($area_code)
    {
        ...
        if (($area_code > 999)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling CreateDomainRequest., must be smaller than or equal to 999.');
        }
        if (($area_code < 100)) {
            throw new \InvalidArgumentException('invalid value for $area_code when calling CreateDomainRequest., must be bigger than or equal to 100.');
        }
