...
/**
 * ConnectionsGet200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class ConnectionsGet200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_connections_get_200_response_inner';
    ...
    */
     ...
     *
     * @param string $connection_orig_match_pattern This is the connection's origination match pattern
     *
     * @return self
     */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling ConnectionsGet200ResponseInner., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[A-Za-z0-9._-]+|\\*/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling ConnectionsGet200ResponseInner., must conform to the pattern /^[A-Za-z0-9._-]+|\\*/.");
        }
