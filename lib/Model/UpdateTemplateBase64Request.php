...
/**
 * UpdateTemplateBase64Request Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTemplateBase64Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTemplateBase64_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['base64_file'] === null) {
            $invalidProperties[] = "'base64_file' can't be null";
        }
     ...
     * Sets reseller
     *
     * @param string|null $reseller The reseller or territory the template file applies to.
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain The domain the template file applies to.
     *
     * @return self
     */
     ...
     * Sets server
     *
     * @param string|null $server The server the template file applies to.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description of the template file to indicate what it is used for
     *
     * @return self
     */
     ...
     * Sets filetype
     *
     * @param string $filetype Encoding (content type) of the template file
     *
     * @return self
     */
     ...
     * Sets base64_file
     *
     * @param string $base64_file A base64 encoded string formatted without line breaks or spaces.
     *
     * @return self
     */
