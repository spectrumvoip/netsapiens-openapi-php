...
/**
 * AddressEndpoint Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class AddressEndpoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressEndpoint';
    ...
    protected static $openAPITypes = [
        ...
        'carrier' => 'string',
        'count_users_configured' => 'int',
        'address_formatted_pretty' => 'string',
        'address_is_default_for_site' => 'bool',
        'location_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'carrier' => null,
        'count_users_configured' => null,
        'address_formatted_pretty' => null,
        'address_is_default_for_site' => null,
        'location_id' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'carrier' => true,
        'count_users_configured' => true,
        'address_formatted_pretty' => true,
        'address_is_default_for_site' => true,
        'location_id' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'carrier' => 'carrier',
        'count_users_configured' => 'count-users-configured',
        'address_formatted_pretty' => 'address-formatted-pretty',
        'address_is_default_for_site' => 'address-is-default-for-site',
    ...
    protected static $setters = [
        ...
        'carrier' => 'setCarrier',
        'count_users_configured' => 'setCountUsersConfigured',
        'address_formatted_pretty' => 'setAddressFormattedPretty',
        'address_is_default_for_site' => 'setAddressIsDefaultForSite',
    ...
    protected static $getters = [
        ...
        'carrier' => 'getCarrier',
        'count_users_configured' => 'getCountUsersConfigured',
        'address_formatted_pretty' => 'getAddressFormattedPretty',
        'address_is_default_for_site' => 'getAddressIsDefaultForSite',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('count_users_configured', $data ?? [], null);
        $this->setIfExists('address_formatted_pretty', $data ?? [], null);
        $this->setIfExists('address_is_default_for_site', $data ?? [], null);
    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 64)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling AddressEndpoint., must be smaller than or equal to 64.');
        }
        if ((!preg_match("/^[A-Za-z0-9._-]+|\\*/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling AddressEndpoint., must conform to the pattern /^[A-Za-z0-9._-]+|\\*/.");
        }
    ...
    /**
     * Gets count_users_configured
     *
     * @return int|null
     */
    public function getCountUsersConfigured()
    {
        return $this->container['count_users_configured'];
    }

    /**
     * Sets count_users_configured
     *
     * @param int|null $count_users_configured This is the count of how many users are using the particular address
     *
     * @return self
     */
    public function setCountUsersConfigured($count_users_configured)
    {
        if (is_null($count_users_configured)) {
            array_push($this->openAPINullablesSetToNull, 'count_users_configured');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('count_users_configured', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['count_users_configured'] = $count_users_configured;

        return $this;
    }

    /**
     * Gets address_formatted_pretty
     *
     * @return string|null
     */
    public function getAddressFormattedPretty()
    {
        return $this->container['address_formatted_pretty'];
    }

    /**
     * Sets address_formatted_pretty
     *
     * @param string|null $address_formatted_pretty This is a human readable format of the address
     *
     * @return self
     */
    public function setAddressFormattedPretty($address_formatted_pretty)
    {
        if (is_null($address_formatted_pretty)) {
            array_push($this->openAPINullablesSetToNull, 'address_formatted_pretty');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_formatted_pretty', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['address_formatted_pretty'] = $address_formatted_pretty;

        return $this;
    }

    /**
     * Gets address_is_default_for_site
     *
     * @return bool|null
     */
    public function getAddressIsDefaultForSite()
    {
        return $this->container['address_is_default_for_site'];
    }

    /**
     * Sets address_is_default_for_site
     *
     * @param bool|null $address_is_default_for_site This is whether the address is a default for the site
     *
     * @return self
     */
    public function setAddressIsDefaultForSite($address_is_default_for_site)
    {
        if (is_null($address_is_default_for_site)) {
            array_push($this->openAPINullablesSetToNull, 'address_is_default_for_site');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_is_default_for_site', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['address_is_default_for_site'] = $address_is_default_for_site;
