...
/**
 * CreateSMSNumberRequest Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class CreateSMSNumberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSMSNumber_request';
    ...
    */
     ...
     * Sets dest
     *
     * @param string|null $dest This is the destination for the SMS number if assigned. Can be a user or a call queue
     *
     * @return self
     */
