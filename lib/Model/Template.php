...
class Template implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets filename
     *
     * @param string|null $filename Name of the template file
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url A URL from which the template file can be downloaded
     *
     * @return self
     */
     ...
     * Sets filesize
     *
     * @param string|null $filesize Size of the template file
     *
     * @return self
     */
