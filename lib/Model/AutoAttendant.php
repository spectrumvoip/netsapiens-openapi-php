...
/**
 * AutoAttendant Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class AutoAttendant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutoAttendant';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('read_path', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['read_path'];
    }

    /**
     * Sets read_path
     *
     * @param string|null $read_path Shown only on a read of multiple auto attendants, will assist in getting the path for reading specific Attendant details.
     *
     * @return self
     */
    public function setReadPath($read_path)
    {
        if (is_null($read_path)) {
            throw new \InvalidArgumentException('non-nullable read_path cannot be null');
        }
        $this->container['read_path'] = $read_path;
