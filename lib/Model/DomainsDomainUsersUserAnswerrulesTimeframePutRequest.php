...
/**
 * DomainsDomainUsersUserAnswerrulesTimeframePutRequest Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class DomainsDomainUsersUserAnswerrulesTimeframePutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_domains__domain__users__user__answerrules__timeframe__put_request';
    ...
    */
    ...
    public function setOrder($order)
    {
        ...
        if (($order < 0)) {
            throw new \InvalidArgumentException('invalid value for $order when calling DomainsDomainUsersUserAnswerrulesTimeframePutRequest., must be bigger than or equal to 0.');
        }
