...
/**
 * UpdateImageBase64Request Class Doc Comment
 *
 * @category Class
 * @package  SpectrumVoip\\\\NetSapiens
 * @author   OpenAPI Generator team
 ...
 */
class UpdateImageBase64Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateImageBase64_request';
    ...
    */
     ...
     * Sets reseller
     *
     * @param string|null $reseller The reseller or territory the image file applies to.
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain The domain the image file applies to.
     *
     * @return self
     */
     ...
     * Sets server
     *
     * @param string|null $server The server the image file applies to.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description of the image file to indicate what it is used for
     *
     * @return self
     */
     ...
     * Sets filetype
     *
     * @param string $filetype Encoding (content type) of the image file
     *
     * @return self
     */
