# SpectrumVoip\\\\NetSapiens\MediaGreetingsApi

All URIs are relative to https://ns-api.com/ns-api/v2, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**createGreetingBase64()**](MediaGreetingsApi.md#createGreetingBase64) | **POST** /domains/{domain}/users/{user}/greetings#2 | Create a new Greeting from Upload (JSON + Base64 File) |
| [**createGreetingFileUpload()**](MediaGreetingsApi.md#createGreetingFileUpload) | **POST** /domains/{domain}/users/{user}/greetings#3 | Create a new Greeting from Upload (Multipart/Mixed Post) |
| [**createGreetingTTS()**](MediaGreetingsApi.md#createGreetingTTS) | **POST** /domains/{domain}/users/{user}/greetings | Create a new Greeting from TTS |
| [**deleteGreeting()**](MediaGreetingsApi.md#deleteGreeting) | **DELETE** /domains/{domain}/users/{user}/greetings/{index} | Delete Specific Greeting for User |
| [**readGreeting()**](MediaGreetingsApi.md#readGreeting) | **GET** /domains/{domain}/users/{user}/greetings/{index} | Read Specific Greeting for User |
| [**readGreetings()**](MediaGreetingsApi.md#readGreetings) | **GET** /domains/{domain}/users/{user}/greetings | Read Greetings for User |
| [**updateGreetingBase64()**](MediaGreetingsApi.md#updateGreetingBase64) | **PUT** /domains/{domain}/users/{user}/greetings/{index}#2 | Update Greeting from Upload (JSON + Base64 File) |
| [**updateGreetingFileUpload()**](MediaGreetingsApi.md#updateGreetingFileUpload) | **PUT** /domains/{domain}/users/{user}/greetings/{index}#3 | Update Greeting from Upload (Multipart/Mixed Post) |
| [**updateGreetingTTS()**](MediaGreetingsApi.md#updateGreetingTTS) | **PUT** /domains/{domain}/users/{user}/greetings/{index} | Update Greeting with TTS script |


## `createGreetingBase64()`

```php
createGreetingBase64($domain, $user, $media_request): \SpectrumVoip\\\\NetSapiens\Model\SuccessResponse
```
...
$apiInstance = new SpectrumVoip\\\\NetSapiens\Api\MediaGreetingsApi(
...
| **media_request** | [**\SpectrumVoip\\\\NetSapiens\Model\MediaRequest**](../Model/MediaRequest.md)|  | [optional] |
...
```php
createGreetingFileUpload($domain, $user, $synchronous, $script, $file, $index, $convert): object
```
...
try {
    $result = $apiInstance->createGreetingFileUpload($domain, $user, $synchronous, $script, $file, $index, $convert);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->createGreetingFileUpload: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createGreetingTTS($domain, $user, $create_greeting_tts_request): object
```
...
$domain = {{domain}}; // string | 
$user = {{user}}; // string | 
$create_greeting_tts_request = new \SpectrumVoip\\\\NetSapiens\Model\CreateGreetingTTSRequest(); // \SpectrumVoip\\\\NetSapiens\Model\CreateGreetingTTSRequest

try {
    $result = $apiInstance->createGreetingTTS($domain, $user, $create_greeting_tts_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->createGreetingTTS: ', $e->getMessage(), PHP_EOL;
}
```
...
| **domain** | **string**|  | [default to &#39;~&#39;] |
| **user** | **string**|  | [default to &#39;~&#39;] |
| **create_greeting_tts_request** | [**\SpectrumVoip\\\\NetSapiens\Model\CreateGreetingTTSRequest**](../Model/CreateGreetingTTSRequest.md)|  | [optional] |
...
```php
deleteGreeting($domain, $user, $index): \SpectrumVoip\\\\NetSapiens\Model\SuccessResponse
```
...
try {
    $result = $apiInstance->deleteGreeting($domain, $user, $index);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->deleteGreeting: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
readGreeting($domain, $user, $index): \SpectrumVoip\\\\NetSapiens\Model\Audiofile
```
...
try {
    $result = $apiInstance->readGreeting($domain, $user, $index);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->readGreeting: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
readGreetings($domain, $user): \SpectrumVoip\\\\NetSapiens\Model\Audiofile[]
```
...
try {
    $result = $apiInstance->readGreetings($domain, $user);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->readGreetings: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateGreetingBase64($domain, $user, $index, $media_request): \SpectrumVoip\\\\NetSapiens\Model\SuccessResponse
```
...
try {
    $result = $apiInstance->updateGreetingBase64($domain, $user, $index, $media_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->updateGreetingBase64: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateGreetingFileUpload($domain, $user, $index, $script, $file, $convert, $synchronous): object
```
...
try {
    $result = $apiInstance->updateGreetingFileUpload($domain, $user, $index, $script, $file, $convert, $synchronous);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->updateGreetingFileUpload: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateGreetingTTS($domain, $user, $index, $update_greeting_tts_request): object
```
...
$user = {{user}}; // string | 
$index = 1; // string | 
$update_greeting_tts_request = new \SpectrumVoip\\\\NetSapiens\Model\UpdateGreetingTTSRequest(); // \SpectrumVoip\\\\NetSapiens\Model\UpdateGreetingTTSRequest

try {
    $result = $apiInstance->updateGreetingTTS($domain, $user, $index, $update_greeting_tts_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MediaGreetingsApi->updateGreetingTTS: ', $e->getMessage(), PHP_EOL;
}
```
...
| **user** | **string**|  | [default to &#39;~&#39;] |
| **index** | **string**|  | |
| **update_greeting_tts_request** | [**\SpectrumVoip\\\\NetSapiens\Model\UpdateGreetingTTSRequest**](../Model/UpdateGreetingTTSRequest.md)|  | [optional] |
